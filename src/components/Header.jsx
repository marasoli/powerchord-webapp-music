export default function Header() {
    return (
        <header className="flex justify-between items-center">
            <div>
                <button className="fa-solid fa-chevron-left bg-[#6B0000] border-2 border-white rounded-sm text-white p-1 w-7 mr-3"></button>
            ...
            <div className="flex items-center relative w-80">
                <input type="text" maxlength="800" placeholder="O que você quer ouvir?" className="border-2 border-white rounded-sm p-0.5 pl-2.5 pr-7.5 text-white w-full outline-none"/>
